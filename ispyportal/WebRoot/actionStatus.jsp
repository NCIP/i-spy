...
<%  
String statusHeader = request.getAttribute(Constants.ATTRIBUTE_STATUS_HEADER).toString();
String statusMessage =  request.getAttribute(Constants.ATTRIBUTE_STATUS_MESSAGE).toString();
%>
