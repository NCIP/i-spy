<%@ page import="gov.columbia.c2b2.ispy.list.ListType,
...
<%
	...
	for(int i=0; i<lts.length; i++)	{
		label = lts[i].toString();
//System.out.println("DEBUGSCRIPT |"+label+"|");
%>
...
//System.out.println("DEBUGSCRIPT |"+label+"|");
%>
	<a name="Shared <%=label%>Lists"></a>
	<fieldset class="groupList" id="<%=label%>ListsFSS">
...
<script type="text/javascript">
		if(!saf)	{
			addLoadEvent(ManageListHelper.generic_shr); 
		}
		else	{
			ManageListHelper.generic_shr("init");
		}
