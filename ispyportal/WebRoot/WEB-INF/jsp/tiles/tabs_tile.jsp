...
<% 
	...
	String analysisSecondary = "<ul id=\"secondary\">\n" +
	  ...
	  String adminSecondary = "<ul id=\"secondary\">\n" +
							"<li><a href=\"analysisHomeWithAdmin.do\">Manage Users</a></li>\n" +
							"<li><a href=\"loadFilesInfo.do\">Uploaded Files</a></li>\n" +
							"</ul>\n";
							
	String s = (String) request.getParameter("s");
	String groupName = (String) session.getAttribute(Constants.CSM_GROUP_NAME);
	...
	if(s != null)	{
		...
		switch(sect)	{
			case 1:
				...
				groups = "<a href=\"manageGroups.do\">Manage User Groups</a>";
				admin = "<a href=\"analysisHomeWithAdmin.do\">Admin</a>";
				break;
			case 2:
				//2 is adv
			...
			case 6:
				...
				analysis = "<a href=\"analysisHome.do\">High Order Analysis</a>";
				list = "<a href=\"manageLists.do\">Manage Lists</a>";
				groups = "<span>Manage User Groups</span>";
				admin = "<a href=\"analysisHomeWithAdmin.do\">Admin</a>";
				break;
		    ...
		    case 7:
				...
				list = "<a href=\"manageLists.do\">Manage Lists</a>";
				groups = "<a href=\"manageGroups.do\">Manage User Groups</a>";
		        admin = "<span>Admin</span>" + adminSecondary;
		        break;
			default:
...
<div id="header">
	<ul id="primary">
		...
		<li><%= list %></li>
		<li><%= groups %></li>	
		<%if (groupName != null && groupName.equals("ADMIN_USER")) 
		 { %>
		    <li><%= admin %></li>	
		<%} %>	
	</ul>
