...
public class testListManager {
    ...
    public static void main(String[] args) {
        ...
        UserListN myList1 = uploadManager.createList(ListType.PatientDID, "myPatientList1", list1,new ISPYListValidator());
        UserListN myList2 = uploadManager.createList(ListType.PatientDID, "myPatientList2", list2,new ISPYListValidator());
        UserListN myList3 = uploadManager.createList(ListType.PatientDID, "myPatientList3", list3,new ISPYListValidator());
