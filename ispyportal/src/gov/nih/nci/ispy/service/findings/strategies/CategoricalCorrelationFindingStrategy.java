...
public class CategoricalCorrelationFindingStrategy extends SessionBasedFindingStrategy {
	...
	public boolean executeQuery() throws FindingsQueryException {
        ...
        if(queryDTO instanceof ISPYCategoricalCorrelationQueryDTO){
            ...
            //populate pdids
            List<UserListN> patientLists = categoricalQueryDTO.getPatientLists();
	 ...
	 * @return
	 */
	private SampleGroup getSampleGroupForPatientList(UserListN patientList, ISPYDataType dataType) {
		 IdMapperFileBasedService im = IdMapperFileBasedService.getInstance();
	...
	private DataPointVector getDataPointsForUserList(UserListN patientList, ContinuousType continuousType) {
