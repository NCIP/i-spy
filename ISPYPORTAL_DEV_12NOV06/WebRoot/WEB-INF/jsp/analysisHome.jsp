  ...
  <fieldset>
		...
		<html:errors property="org.apache.struts.action.GLOBAL_ERROR"/>
			<table border="0" cellpadding="3" cellspacing="3">
				...
				<tr><td><input type="button" class="xbutton" style="width:200px;margin-bottom: 5px;" value="Categorical Correlation Plot Analysis" onclick="javascript:location.href='categoricalCorrelationInit.do?method=setup';"></td></tr>			
			</table>
	</fieldset>
	</td></tr>
