   ...
   <xsl:for-each select="Report">
	...
	<xsl:if test="$recordCount > 0">
	    ...
	    <span style="z-index:900; float:right;position:absolute;top:10px;right:10px;">
		  ...
		  <xsl:if test="/Report[@reportType = 'IHC Level Of Expression']">
		  ...
		  <a href="#"><img align="right" src="images/excel.png" border="0" alt="download for excel" onmouseover="return overlib('Download for Excel.', CAPTION, 'Help', CSSCLASS,TEXTFONTCLASS,'fontClass',FGCLASS,'fgClass',BGCLASS,'bgClass',CAPTIONFONTCLASS,'capfontClass', OFFSETX, -50);" onmouseout="return nd();"/></a>
