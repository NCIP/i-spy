...
import gov.nih.nci.ispy.service.annotation.IdMapperEntry;
...
public class IdMapperFileBasedServiceTester {
	...
	public static void main(String[] args) {
		...
		idMapper.setMappingFile("C:\\eclipse\\workspace\\ispyportal\\WebRoot\\WEB-INF\\data_files\\idMappingFile4-6-06.txt");
		 
		List<String> inputList = new ArrayList<String>();
		inputList.add("212283");
		inputList.add("1024");
		List<IdMapperEntry> entries = idMapper.getMapperEntriesForIds(inputList);
