...
public class ISPYImageFileHandler {
	...
	private static Logger logger = Logger.getLogger(ISPYImageFileHandler.class);
	...
	public ISPYImageFileHandler(String userSessionId,String imageTypeExtension, int width, int height) {
		if(tempDir.equals("")) {
			/**
