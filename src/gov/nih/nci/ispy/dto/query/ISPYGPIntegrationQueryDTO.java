...
public class ISPYGPIntegrationQueryDTO implements GpIntegrationQueryDTO {
	...
	private HashMap<String, UserList> patientLists; 
	...
	public HashMap<String, UserList> getPatientLists() {
		return patientLists;
	}
	public void setPatientLists(HashMap<String, UserList> patientLists) {
