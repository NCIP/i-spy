   ...
   <xsl:for-each select="Report">
	...
	<xsl:if test="$recordCount > 0">
	    ...
	    <span style="z-index:900; float:right;position:absolute;top:10px;right:10px;">
		  ...
		  <script type="text/javascript">Help.insertHelp("Class_comparison_report", " align='right'", "padding:2px;");</script>
	  ...
	  -->
			...
			<div class="filterForm">
				<b><span class="lb">Select Genes:</span></b> 
				<xsl:text>&#160;</xsl:text>
				...
				<span id="checkAllBlock"><input type="checkbox" name="checkAll" id="checkAll" class="checkorradio" onclick="javascript:SaveGenes.A_checkAllOnAll(this);"/> Check All</span>
			 	...
			 	<xsl:text>&#160;</xsl:text>
			 	<a href="#" onclick="javascript:SaveGenes.A_clearTmpGenes(); return false;" onmouseover="javascript:return showHelp('Clear these genes');" onmouseout="return nd();">[clear genes]</a>
